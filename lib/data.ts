...
import { SiAndroidstudio, SiC, SiCss3, SiExpress, SiFirebase, SiFramer, SiGit, SiGithub, SiHtml5, SiJavascript, SiKotlin, SiMongodb, SiNextdotjs, SiNgrok, SiNodedotjs, SiPrisma, SiPython, SiReact, SiStmicroelectronics, SiTailwindcss, SiTypescript } from "react-icons/si";
