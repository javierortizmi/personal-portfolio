...
export default function LocaleSwitch({
  ...
  return (
    <Link
      ...
      href={lang === i18n.locales[0] ? redirectedPathName(i18n.locales[1]) : redirectedPathName(i18n.locales[0])}
    >
      {lang === i18n.locales[0] ? <GB className="w-6 rounded-sm" /> : <ES className="w-6 rounded-sm" />}
    </Link>
  );
}
